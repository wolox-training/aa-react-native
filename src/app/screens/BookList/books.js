...
export const defaultBooks = [
    ...
    { id: 2, title: 'The Best Book in the World', author: 'Peter Sjernstrom', imageSource: imageBook3, year: '2013', type: 'Novel', comments: [{ id: 1, user: user1, comment: 'It was great to see you again earlier. Let’s definitely get that coffe It was great to see you again earlier.'}, { id: 2, user: user2, comment: 'Let’s definitely get that coffe It was great to see you again earlier. ' }, { id: 1, user: user1, comment: 'It was great to see you again earlier. Let’s definitely get that coffe It was great to see you again earlier.'}, { id: 2, user: user2, comment: 'Let’s definitely get that coffe It was great to see you again earlier. ' } ] },
